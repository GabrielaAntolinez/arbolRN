        ...
        for (int i = 2; i < nodo.size(); i++) {
            ...
            switch(position){
                case 0:
                    ...
                    b.setBounds(aa, (size*45)+10, 30, 30);
                    aa = aa+30;
                    break;
                case 1:
                    a.setBounds(bb,(size-1)*45,30,30);
                    b.setBounds(bb,((size-1)*45)+10,30,30);
                    bb = bb+45;
                    break;
                case 2: 
                    a.setBounds(cc,(size-2)*45,30,30);
                    b.setBounds(cc,((size-2)*45)+10,30,30);
                    cc = cc + 105;
                    break;
                case 3: 
                    a.setBounds(dd,(size-3)*45,30,30);
                    b.setBounds(dd,((size-3)*45)+10,30,30);
                    dd = dd + 45;
                    break;
                case 4:
                    a.setBounds(ee,(size-4)*45,30,30);
                    a.setBounds(ee,((size-4)*45)+10,30,30);
                    ee = ee + 55;
                    break;
            }
            panel.add(a);
